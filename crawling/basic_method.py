...
def read_json(filepath = "LBS\Location-Based_Service_Project\crawling\settings.json"):
    ''' read_json 함수는 json 파일을 읽어오는 함수
        json 파일을 읽어서 딕셔너리 형태로 반환

        filepath : 읽어올 json 파일의 경로
    '''
